...
Next, we will handle the case where the sets have infinite cardinality. We again assume that $\vert B' \vert \leq \vert B \vert$ without loss of generality. Pick $w \in B'$. We know that 
